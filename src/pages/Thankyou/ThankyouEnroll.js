      ...
      <div class=''>
        <div class='p-4 sm:p-8 rounded-lg shadow-lg ring ring-orange-600/50'>
          <div class='flex flex-col items-center space-y-4 sm:space-y-8'>
            ...
            <Link
              class='inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 text-white bg-[#F86F03] border border-orange-400 rounded-3xl hover:bg-orange-600 focus:outline-none focus:ring'
              to='/'
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
