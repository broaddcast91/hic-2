        ...
        <div className='flex space-x-9 '>
          <div className='w-8/12'>
            <div className='text-left  mt-10 '>
              ...
              <p className='mt-5'>
                The Deluxe Double room at our venue offers an exquisite setting
                for your special occasions. With its elegant decor and spacious
                layout, it provides the perfect backdrop for weddings,
                ...
                celebration, our Deluxe Double room is the ideal choice to
  ...
  return (
    <>
      <div className='container mx-auto mt-8 p-4 bg-orange-200'>
        <h2 className='text-2xl font-semibold mb-4'>Book Deluxe Double Room</h2>
