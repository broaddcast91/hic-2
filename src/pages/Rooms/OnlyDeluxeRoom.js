...
const DelRoomSingle = () => {
  const [selectedOption, setSelectedOption] = useState('5,699.00');
...
const DelRoomDouble = () => {
  const [selectedOption, setSelectedOption] = useState('6,599.00');
                ...
                <div class='flex-none font-semibold text-left text-xs text-blue-600'>
                  <div className='flex-none text-gray-600 text-left mt-2'>
                    <div className='w-64'>
                      <select
                        id='selectOption'
                        defaultValue='6,599.00'
                        value={selectedOption}
                        onChange={handleSelectChange}
                        className='rounded-3xl w-full shadow border-gray-300 text-gray-500'
                      >
                        <option value='6,599.00'>Double Bed</option>
                      </select>
                    </div>
                  </div>
                </div>
