...
const StdRoomSingle = () => {
  const [selectedOption, setSelectedOption] = useState('4499.00');
...
const StdRoomDouble = () => {
  const [selectedOption, setSelectedOption] = useState('5299.00');
...
export default OnlyStandardRoom;
