...
const SearchRoom = () => {
  ...
  return (
    <div className='container mx-auto md:px-12 flex flex-col sm:flex-row items-center justify-center mt-8 py-2 px-4 border bg-white text-black  absolute bottom-1 left-1/2 transform -translate-x-1/2 text-sm'>
