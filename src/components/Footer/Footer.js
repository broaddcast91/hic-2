      ...
      <footer class='bg-white'>
        <div class='mx-auto max-w-screen-xl px-4 pb-6 pt-10 sm:px-6 lg:px-8 lg:pt-18'>
          <div class='grid grid-cols-1 gap-8 lg:grid-cols-3'>
            <div>
              <div class='flex justify-center text-[#F86F03] sm:justify-start'>
              ...
              <ul class='mt-8 flex justify-center gap-6 sm:justify-start md:gap-8'>
                <li>
                  <Link
                    ...
                    rel='noreferrer'
                    target='_blank'
                    class='text-[#EA580C] transition hover:text-[#EA580C]'
                  >
            ...
            <div class='grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2'>
              <div class='text-center sm:text-left'>
                <p class='text-lg font-bold text-orange-600'>Services</p>
              ...
              <div class='text-center sm:text-left'>
                <p class='text-lg font-bold text-[#F86F03]'>Rooms</p>
              ...
              <div class='text-center sm:text-left'>
                <p class='text-lg font-bold text-[#F86F03]'>Helpful Links</p>
              ...
              <div class='text-center sm:text-left'>
                <p class='text-lg font-bold text-[#F86F03]'>Contact Us</p>
                ...
                <ul class='mt-8 space-y-4 text-sm'>
                  ...
                  <li class='flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end'>
                    ...
                    <address class='-mt-0.5 flex-1 not-italic text-gray-700'>
                      Saboo Heights, <br /> 6-3-905, <br /> Raj Bhavan Rd,
                      <br />
          ...
          <div class='mt-12 border-t border-gray-100 pt-6'>
            <div class='text-center sm:flex sm:justify-between sm:text-left'>
              <p class='text-sm text-gray-500'>
                ...
                <Link
                  class='inline-block text-[#EA580C] underline transition hover:text-[#EA580C]'
                  to='/privacypolicy'
                >
                  Terms & Conditions
                </Link>
